...
void LcdPutBmp4(unsigned char const * bmp,unsigned int x,unsigned int y);
//void LcdPutBmp4(struct page_info * p,unsigned int x,unsigned int y);

void LcdPutBmp5();
void LcdUpdate();
void LcdClear();
void LcdPutBmp(unsigned char const * bmp,unsigned char x,unsigned char y,unsigned char w,unsigned char h,char mode);
